...
const Menu = () => {
    const {
         Products,menu, setMenu, getMenu, setSelectedMenu,
         alert, setAlert, increaseOrder
    }=useContext(CartContext)
  return (
    <div className='container mx-auto'>
        {/*Category Selection*/}
        <div className= 'flex justify-center items-center sm:gap-x-2 lg:gap-x-3 p-5'>
        <Button variant='contained' color='warning' onClick={()=>setSelectedMenu(0)}>All</Button>
        <Button variant='contained' color='warning' onClick={()=>setSelectedMenu(1)} >Pizza</Button>
        <Button variant='contained' color='warning' onClick={()=>setSelectedMenu(2)}>Burger</Button>
        <Button variant='contained' color='warning' onClick={()=>setSelectedMenu(3)}>Drinks</Button>
        <Button variant='contained' color='warning' onClick={()=>setSelectedMenu(4)}>Desserts</Button>
        <a href="/cart"><BsFillCartCheckFill size={40} color='green'/></a> 
        </div>
